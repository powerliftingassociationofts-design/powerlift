  ...
  const results = [
    {
      ...
      event: "Benchpress",
      image:
        "https://images.unsplash.com/photo-1579758629938-03607ccdbaba?auto=format&fit=crop&w=900&q=80", // Gold - working gym photo
    },
    {
      id: 2,
    ...
    },
    {
      ...
      event: "Powerlifting",
      image:
       "https://images.unsplash.com/photo-1605296867304-46d5465a13f1?auto=format&fit=crop&w=900&q=80", // Bronze - gym athlete
    },
  ];
    ...
    <section className="results-page py-5">
      <div className="container">
        ...
        <div className="section-title text-center mb-5">
          ...
          <p className="section-title__text text-white text-2xl ">
